...
<head>
  ...
  <link href="css/logingoogle.css" rel="stylesheet">
...
<!-- 6LfYSfkeAAAAANbGBnUtw6LryMNZtkfqmgBQesrl-->
  <script src="https://www.google.com/recaptcha/api.js?6LfSBgYfAAAAAIKQTytH81dIRT8pgt60pNtlw_y_"></script>
<!-- HACIENDO LLAMAR API DE RECAPTCHA -->
</head>
  ...
  <div class="container">
    <div class="forms-container">
      <div class="signin-signup">
          ...
          <p class="subtitle">Ingresa la siguiente información para iniciar sesión.</p>
          <br>
...
/*
      <!-- ID PARA HACER LLAMAR EL RECAPCHAT-->
        ...
        <div class="g-recaptcha" data-sitekey="6LfSBgYfAAAAAJz1RO8W33wf0T00oOIjQvCGfddm"></div>
