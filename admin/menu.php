      ...
      <div class="container-fluid">
         ...
         <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
               ...
               <li class="nav-item">
                  <a class="nav-link active" aria-current="page" href="formLibro.php">Registrar Libro</a>
               </li>
               ...
               <li class="nav-item">
                  <a class="nav-link active" aria-current="page" href="../bd/cerrar.php" style="color:red">Cerrar
                     Sesión</a>
               </li>
            </ul>
            <form class="d-flex">
               <input class="form-control me-2" type="search" placeholder="Nombre del Libro" aria-label="Search" required>
...
<script>
   baja.addEventListener('click', function(e) {
      ...
      alertpreunta('¿DESEA ELIMINAR A LOS ALUMNOS DADOS DE BAJA?',
         'SE ACTUALIZARA LA INFOMACION DE REGISTRO SEGUN LOS DATOS PROPORCIONADOS POR EL SERVIDOR SE DARA DE BAJA DEFINITIVAMENTE',
         'warning', 'eliminarAlumnos.php');
   });
   alta.addEventListener('click', function(e) {
      e.preventDefault();
      alertpreunta('¿DESEA ACTUALIZAR A LOS ALUMNOS NUEVOS?',
         'SE ACTUALIZARA LA INFOMACION DE REGISTRO SEGUN LOS DATOS PROPORCIONADOS POR EL SERVIDOR REGISTRA A LOS NUEVOS ALUMNO',
